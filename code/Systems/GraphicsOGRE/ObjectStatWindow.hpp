...
/// <summary>
///		Stat window.  Display interesting statistics about how the code is running.
/// </summary>
class OGREGraphicsObjectStatWindow : public OGREGraphicsObjectWindow
{
    friend OGREGraphicsScene;

protected:

	/// <summary cref="OGREGraphicsObjectStatWindow::OGREGraphicsObjectStatWindow">
	...
	OGREGraphicsObjectStatWindow( ISystemScene* pSystemScene, pcstr pszName );

	/// <summary cref="OGREGraphicsObjectStatWindow::~OGREGraphicsObjectStatWindow">
	///		Basic destructor; the only one.
	/// </summary>
    ~OGREGraphicsObjectStatWindow( void );

	/// <summary cref="OGREGraphicsObjectStatWindow::Update">
...
private:
	...
	/// <summary cref="OGREGraphicsObjectStatWindow::GetWindowDataUpdate">
