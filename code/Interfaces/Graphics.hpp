...
namespace IndexDecl
{
    ...
    COMPILER_INLINE u32 CalculateSize( In u32 Type )
    {
...
namespace VertexDecl
{
    ...
    COMPILER_INLINE u32 FindUsageInStream( In Element* pElements, In u32 cElements, In u32 VertUsage, In u32 UsageIndex=0 )
    {
    ...
    COMPILER_INLINE u32 CalculateSize( In Element* pElements, In u32 cElements, u32 StreamIndex=0 )
    {
        u32 Size = 0;
    ...
    COMPILER_INLINE i32 CalculateUsageOffsetInVertex( In Element* pElements, In u32 cElements,
